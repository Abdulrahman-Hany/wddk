...
/*----------------------------------------------------------------*/
// Date Navigation for Restaurant Details
document.addEventListener('DOMContentLoaded', () => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const reservationdate = document.querySelector(".reservation-container .date-header");
  const reservationBooking = document.querySelector(".reservation-container .booking-option");
  const reservationAppointment = document.querySelectorAll(".reservation-container .appointment-container");
  const reservationMape = document.querySelector(".reservation-container .map-restaurant");
  ...
  const workingHoursSchedule = document.querySelector(".working-hours-schedule");
...
// Check for arrows and container existence
if (container) {
  if (leftArrow) {
...
// تعريف الدالة
function setupCounter(decrementBtn, incrementBtn, countElement, min = 0, max = 10) {
...
/* ===============*/
        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          themeToggle.checked = false; // تعيين الزر إلى غير مفعّل (الوضع النهاري)
          // تبديل الوضع عند تغيير الحالة
          themeToggle.addEventListener("change", () => {
              if (themeToggle.checked) {
                  body.classList.add("dark-mode"); // تفعيل الوضع الداكن
              } else {
                  body.classList.remove("dark-mode"); // العودة للوضع النهاري
              }
          });
      });
